...
export default [
  ...
  // },
  {
    ...
    //       keepAlive: true,
    //     },
    //     component: defineAsyncComponent(() => import('@/pages/hierarchicalControl/index.vue')),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/surpervision/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/order/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/personnelStatistics/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/workReminder/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/alarmSetting/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/problemmMoniMore/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/productionFactorsMore/index.vue')
    //     ),
    //   },
    //   {
    ...
    //     isShow: true,
    //     component: defineAsyncComponent(() =>
    //       import('@/pages/hierarchicalControl/warningStatistics/index.vue')
    //     ),
    //   },
    // ],
  },
  ...
  //       isShow: true,
  //       component: defineAsyncComponent(
  //         () => import('@/components/pages/productionFactors/index.vue')
  //       ),
  //     },
  //     {
  ...
  // },
  {
    ...
    children: [
      ...
      //   name: '五维评价',
      //   isShow: true,
      //   component: defineAsyncComponent(() => import('@/pages/workOrderHangUp/index.vue')),
      // },
      // {
  ...
  //   name: '暂停接单记录',
  //   isShow: true,
  //   component: () => import('@/pages/pauseReceptWorkOrder/index.vue'),
  // },
  ...
  //   name: '地图标注',
  //   isShow: true,
  //   component: () => import('@/components/pages/mapJsonGather/index.vue'),
  // },
  {
    path: '/nullAuth',
    name: 'nullAuth',
